...
class LoginPage:
    ...
    def logged(self):
        ...
        if(mode=="2"):
            sql2="Select * from agent where username=%s and pwd=%s"
            cur2.execute(sql2,[(username),(pwd)])
    ...
    def __init__(self, window):
        ...
        self.login = Button(self.lgn_button_label, text='LOGIN', font=("yu gothic ui", 13, "bold"),command=self.logged, width=25, bd=0,
        ...
        self.signup_button_label = Button(self.lgn_frame, image=self.signup_img, bg='#98a65d', cursor="hand2",command=self.signuped,
        ...
        self.user = Radiobutton(self.lgn_frame, text="User",font=("yu gothic ui", 13),
                                     fg="yellow",value="1",variable=self.i,background="#040405",
                                     cursor="hand2")
        self.user.place(x=630, y=510)

        self.agent=Radiobutton(self.lgn_frame, text="Agent",font=("yu gothic ui", 13),
                                     fg="yellow",value="2",variable=self.i,
                                     background="#040405", cursor="hand2")
        self.agent.place(x=700, y=510)
