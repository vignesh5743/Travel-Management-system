...
def reserve():
        ...
        res=con.cursor()
        q = "INSERT INTO airline1(airlinenamevalue,airlinenovalue,routevalue,journeyfromvalue,journeytovalue,classvalue,depdate,contact) VALUES(%s,%s,%s,%s,%s,%s,%s,%s);"
        val=(airlinenamevalues,airlinenovalues,routevalues,journeyfromvalues,journeytovalues,classvalues,depdates,phnovalues)
        res.execute(q,val)
        con.commit()
        print("updated")
...
def main():
    ...
    f = f.resize((1366,920))        #setting size for background image
    ...
    tk.Label(text="AIRLINE TICKET RESERVATION",font=("Century Gothic BOLD",18),bg="black",fg="white").place(x=125,y=100)    #setting a heading for the register frame with bg and fg
    
    #creating and placing attributes' label
    

    tk.Label(text="ROUTE",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=250)
    tk.Label(text="Flight NAME",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=150)
    tk.Label(text="Flight NO",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=200)
    tk.Label(text="JOURNEY FROM",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=300)
    tk.Label(text="JOURNEY TO",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=350)
    tk.Label(text="CLASS",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=400)
    tk.Label(text="DEPARTURE/JOURNEY DATE",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=450)
    tk.Label(text="PHONE NO",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=120,y=500)
    ...
    depdate.place(x=320,y=450)
    
    #placing textfields
    
    routeentry.place(x=320,y=250)
    flightnameentry.place(x=320,y=150)
    flightnoentry.place(x=320,y=200)
    journeyfromentry.place(x=320,y=300)
    journeytoentry.place(x=320,y=350)
    classentry.place(x=320,y=400)
    phnoentry.place(x=320,y=500)    
