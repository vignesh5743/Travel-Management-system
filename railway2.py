...
phnovalue=tk.StringVar()

con = mysql.connector.connect(host ="localhost",user = "root",password = "vignesh2003",db ="transport")
cur = con.cursor()

def reserve():
    quotavalues=quotavalue.get()
    trainnamevalues=trainnamevalue.get()
    trainnovalues=trainnovalue.get()
    journeyfromvalues=journeyfromvalue.get()
    journeytovalues=journeytovalue.get()
    depdates=depdate.get()
    classvalues=classvalue.get()
    phnovalues=phnovalue.get()
    
    res=con.cursor()
    q = "INSERT INTO train1(quotavalue,trainnamevalue,trainnovalue,journeyfromvalue,journeytovalue,depdate,classvalue,contact) VALUES(%s,%s,%s,%s,%s,%s,%s,%s);"
    val=(quotavalues,trainnamevalues,trainnovalues,journeyfromvalues,journeytovalues,depdates,classvalues,phnovalues)
    res.execute(q,val)
    con.commit()
...
def main():
    ...
    f = f.resize((1366,820))        #setting size for background image
    ...
    tk.Label(text="RAILWAY TICKET RESERVATION",font=("Century Gothic BOLD",18),bg="black",fg="grey").place(x=833,y=100)    #setting a heading for the register frame with bg and fg
    
    #creating and placing attributes' label
    
    tk.Label(text="RESERVATION QUOTA",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=150)
    tk.Label(text="TRAIN NAME",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=200)
    tk.Label(text="TRAIN NO",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=250)
    tk.Label(text="JOURNEY FROM",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=300)
    tk.Label(text="JOURNEY TO",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=350)
    tk.Label(text="CLASS",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=450)
    tk.Label(text="DEPARTURE/JOURNEY DATE",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=400)
    tk.Label(text="PHONE NO",font=("Century Gothic",10),fg="black",borderwidth=3,relief=tk.RIDGE).place(x=840,y=500)
    ...
    depdate.place(x=1040,y=400)
    phnoentry = tk.Entry(w1,fg="black",bg="darkgrey",textvariable=phnovalue)
    
    #placing textfields
    
    quotaentry.place(x=1040,y=150)
    trainnameentry.place(x=1040,y=200)
    trainnoentry.place(x=1040,y=250)
    journeyfromentry.place(x=1040,y=300)
    journeytoentry.place(x=1040,y=350)
    classentry.place(x=1000,y=450)
    phnoentry.place(x=1040,y=500)
